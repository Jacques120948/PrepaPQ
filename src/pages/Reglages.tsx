...
export default function Reglages() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="text-2xl font-bold text-degrade-marque">Réglages</h1>

      <section className="flex flex-col gap-2 rounded-2xl border border-tole bg-white p-4">
        ...
        <button
          type="button"
          onClick={effacer}
          className="min-h-11 self-start rounded-full border-2 border-rouge px-4 text-sm font-semibold text-rouge hover:bg-rouge/10"
        >
      ...
      <section className="flex flex-col gap-1 rounded-2xl border border-tole bg-white p-4 text-sm text-encre/70">
